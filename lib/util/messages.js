...
module.exports = function(projectName) {
  return {
    ...
    gitCloneError: "There was an issue running " + "git clone ".cyan + "to download the Jam for Apps template.\nMake sure your computer's Git is configured properly and then try again.",
    ...
    installSuccessFinal: "\nNow run " + "jam watch ".cyan + "while inside the " + projectName.cyan + " folder.\n",
    installFailFinal: "\nOnce you've resolved the above issues, run " + "jam watch ".cyan + "while inside the " + projectName.cyan + " folder.\n"
  }
}
